...
def search_products(keyword:str,case_sensitive:bool=False):
 if case_sensitive:
 ...
 return{"keyword":keyword,"case_sensitive":case_sensitive,"results":results,"total_matches":len(results)}
